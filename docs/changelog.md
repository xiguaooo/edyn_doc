...
- 依据新版《伊甸园史记 (1).docx》，修正 `docs/history/rebirth.md` 中的事件经过，将二群申诉日期改为 07-10 至 07-13。
- 区分伊隐当时的说法、牢金此前遭霸凌及报警的背景和作者评论；删除“群组遭平台处理”“替罪羊效应”、自残、休学及“相互拉黑”等原文未支持的扩写。
- 明确原文所述 F 威胁、辱骂使牢金退群，以及询问伊隐后拉黑牢金的经过；同步 `docs/timeline.md` 的摘要和章节链接。
